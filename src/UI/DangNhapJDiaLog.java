...
public class DangNhapJDiaLog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txttendangnhap.setText("Nhập Mã Nhân Viên");
...
//            System.out.println("0");
    ...
    public int Validate() {
        ...
        if (mk.equals("Nhập Mã Nhân Viên")) {
    ...
    public void TextName() {
        ...
        txttendangnhap.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (txttendangnhap.getText().equals("Nhập Mã Nhân Viên")) {
    ...
    private void Close() {
        System.exit(0);
        MsgBox.alert(this, "Xin chào và hẹn gặp lại !!");
    }
}
