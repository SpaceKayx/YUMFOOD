...
//        });
    ...
    int Validate1() {
        ...
        if (patternMatches(txtEmail.getText(), regexPattern) == false) {
            txtEmail.setBackground(Color.yellow);
            MsgBox.alert(this, "Email của bạn không đúng định dạng");
        } else {
            txtEmail.setBackground(Color.white);
            check++;
        }
        if (check == 2) {
            list = nvDAO.selectBySQL("Select * from NhanVien where Email like ?", txtEmail.getText());
            if (list.size() == 0) {
...
//        if (manv != nv.getMaNV()) {
//            txtMaNV.setBackground(Color.yellow);
//            MsgBox.alert(this, "Mã nhân viên không trùng khớp");
//        } else {
//            txtMaNV.setBackground(Color.white);
//            check++;
//        }
    ...
    private void initComponents() {
        ...
        kButton6.setText("Quay lại");
        kButton6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        kButton6.setkBackGroundColor(new java.awt.Color(0, 153, 153));
        kButton6.setkEndColor(new java.awt.Color(0, 153, 153));
        kButton6.setkHoverEndColor(new java.awt.Color(0, 153, 153));
        kButton6.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        kButton6.setkHoverStartColor(new java.awt.Color(0, 153, 153));
        kButton6.setkSelectedColor(new java.awt.Color(0, 153, 153));
        ...
        kGradientPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(kGradientPanel5Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(kGradientPanel5Layout.createSequentialGroup()
                        .addComponent(kButton4, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        kGradientPanel5Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel5Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(kButton4, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
