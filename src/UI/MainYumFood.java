...
public class MainYumFood extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnMenuBarLayout.setHorizontalGroup(
            ...
            .addGroup(pnMenuBarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnDoiMatKhau, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void open_Hoadon() {
        pnlHoaDon_HDCT1.FillTableSanPham();
        pnlHoaDon_HDCT1.FillTableHoaDon();
        pnlHoaDon_HDCT1.fill_GiamGia();
        jTabbedPane1.setSelectedIndex(5);
        color_HoaDon();
    }

    private void open_Giamgia() {
        pnlGiamGia1.fillToTable();
        jTabbedPane1.setSelectedIndex(2);
        color_GiamGia();
    }

    private void open_NhanVien() {
        pnlNhanVien2.fillDataToTable();
        jTabbedPane1.setSelectedIndex(4);
        color_NhanVien();
    }

    private void open_SanPham() {
        pnlSanPham2.fillToTable();
//        kbtnSua.setEnabled(false);
//        kbtnXoa.setEnabled(false);
        pnlSanPham2.fillToTable_LH();
        pnlSanPham2.fillCombobox_LHH();
        jTabbedPane1.setSelectedIndex(3);
        color_SanPham();
    }

    private void open_DoanhThu() {
        pnlDoanhThu1.FillDoanhThu();
        pnlDoanhThu1.FillSPBanChay();
        pnlDoanhThu1.FillSPBanChayNhat();
        pnlDoanhThu1.fillToTableDoanhThuNgay();
